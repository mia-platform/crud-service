FROM node:20.12.1-bullseye-slim as base-with-encryption
...
FROM node:20.12.1-bullseye-slim as crud-service-no-encryption
...
LABEL maintainer="Mia Platform Core Team<core@mia-platform.eu>" \
    ...
    eu.mia-platform.version="7.0.2-rc.0"
