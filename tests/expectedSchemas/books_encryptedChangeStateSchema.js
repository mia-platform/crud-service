...
module.exports = {
  'summary': 'Change state of an item of books-encrypted collection.',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'params': {
    'operationId': 'books-encrypted__MIA__changeState__MIA__params',
    'properties': {
      'id': {
        'type': 'string',
  ...
  'querystring': {
    'operationId': 'books-encrypted__MIA__changeState__MIA__querystring',
    'type': 'object',
    'properties': {
      'name': {
        'type': 'string',
  ...
  'body': {
    'operationId': 'books-encrypted__MIA__changeState__MIA__body',
    'type': 'object',
    'required': [
      'stateTo',
    ],
