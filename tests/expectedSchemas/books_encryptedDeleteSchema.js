...
module.exports = {
  'summary': 'Delete an item with specific ID from the books-encrypted collection.',
  'tags': [
  ...
  'params': {
    ...
    'operationId': 'books-encrypted__MIA__deleteItem__MIA__params',
  },
  'querystring': {
    'operationId': 'books-encrypted__MIA__deleteItem__MIA__querystring',
    'type': 'object',
    'properties': {
      'name': {
        'type': 'string',
