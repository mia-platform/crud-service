...
module.exports = {
  'summary': 'Update an item in the books-encrypted collection. If the item is not in the collection, it will be inserted.',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'querystring': {
    'operationId': 'books-encrypted__MIA__upsertOne__MIA__querystring',
    'type': 'object',
    'properties': {
      'name': {
        'type': 'string',
  ...
  'body': {
    'operationId': 'books-encrypted__MIA__upsertOne__MIA__body',
    'type': 'object',
    'properties': {
      '$set': {
        'type': 'object',
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__upsertOne__MIA__response.200',
      'type': 'object',
      'properties': {
        '_id': {
          'type': 'string',
