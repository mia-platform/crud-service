...
module.exports = {
  'summary': 'Update the items of the books-encrypted collection that match the query.',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'querystring': {
    'operationId': 'books-encrypted__MIA__patchMany__MIA__querystring',
    'type': 'object',
    'properties': {
      '_id': {
        'type': 'string',
  ...
  'body': {
    'operationId': 'books-encrypted__MIA__patchMany__MIA__body',
    'type': 'object',
    'properties': {
      '$set': {
        'type': 'object',
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__patchMany__MIA__response.200',
      'type': 'number',
