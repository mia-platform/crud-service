...
module.exports = {
  'summary': 'Returns the number of items in the books-encrypted collection.',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'querystring': {
    'operationId': 'books-encrypted__MIA__count__MIA__querystring',
    'type': 'object',
    'properties': {
      '_id': {
        'type': 'string',
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__count__MIA__response.200',
      'type': 'integer',
      'minimum': 0,
    },
  },
