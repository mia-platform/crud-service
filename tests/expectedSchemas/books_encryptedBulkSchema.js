...
module.exports = {
  'summary': 'Insert new items in the books-encrypted collection.',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'body': {
    'operationId': 'books-encrypted__MIA__postBulk__MIA__body',
    'type': 'array',
    'items': {
      'type': 'object',
      'required': [
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__postBulk__MIA__response.200',
      'type': 'array',
      'items': {
        'type': 'object',
        'properties': {
