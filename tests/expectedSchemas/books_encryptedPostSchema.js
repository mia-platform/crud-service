...
module.exports = {
  'summary': 'Add a new item to the books-encrypted collection.',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'body': {
    'operationId': 'books-encrypted__MIA__postItem__MIA__body',
    'type': 'object',
    'required': [
      'name',
      'isbn',
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__postItem__MIA__response.200',
      'type': 'object',
      'properties': {
        '_id': {
          'type': 'string',
