...
module.exports = {
  'summary': 'Returns the item with specific ID from the books-encrypted collection.',
  'tags': [
  ...
  'params': {
    ...
    'operationId': 'books-encrypted__MIA__getItem__MIA__params',
  },
  'querystring': {
    'operationId': 'books-encrypted__MIA__getItem__MIA__querystring',
    'type': 'object',
    'properties': {
      'name': {
        'type': 'string',
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__getItem__MIA__response.200',
      'type': 'object',
      'properties': {
        '_id': {
          'type': 'string',
