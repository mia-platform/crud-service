...
module.exports = {
  'summary': 'Update the item with specific ID in the books-encrypted collection.',
  'tags': [
  ...
  'params': {
    ...
    'type': 'object',
    'operationId': 'books-encrypted__MIA__patchItem__MIA__params',
  },
  'querystring': {
    'operationId': 'books-encrypted__MIA__patchItem__MIA__querystring',
    'type': 'object',
    'properties': {
      'name': {
        'type': 'string',
  ...
  'body': {
    'operationId': 'books-encrypted__MIA__patchItem__MIA__body',
    'type': 'object',
    'properties': {
      '$set': {
        'type': 'object',
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__patchItem__MIA__response.200',
      'type': 'object',
      'properties': {
        '_id': {
          'type': 'string',
