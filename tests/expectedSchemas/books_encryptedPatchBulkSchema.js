...
module.exports = {
  'summary': 'Update multiple items of books-encrypted, each one with its own modifications',
  'tags': [
    'Books Encrypted Endpoint',
  ],
  'body': {
    'operationId': 'books-encrypted__MIA__patchBulk__MIA__body',
    'type': 'array',
    'items': {
      'type': 'object',
      'properties': {
  ...
  'response': {
    '200': {
      'operationId': 'books-encrypted__MIA__patchBulk__MIA__response.200',
      'type': 'integer',
      'minimum': 0,
    },
  },
