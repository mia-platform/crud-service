...
function compareValues(valA, valB) {
  // Handle nulls/undefined — null is less than any value (matches MongoDB BSON ordering).
  // The caller negates the result for DESC sort, so nulls naturally move to the end in DESC
  // and to the beginning in ASC, exactly like MongoDB.
