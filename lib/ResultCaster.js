...
const getTypeFromCollectionDefinitionDeprecated = (collectionDefinition, type) => collectionDefinition.fields
  .filter(field => field.type === type)
  .map(field => field.name)

const getTypeFromCollectionDefinition = (collectionDefinition, type) => {
  if (!collectionDefinition.schema) {
    return getTypeFromCollectionDefinitionDeprecated(collectionDefinition, type)
  }

  return Object
    .entries(collectionDefinition)
