...
const { getAjvResponseValidationFunction, shouldValidateStream, shouldValidateItem, ajvValidator } = require('./validatorGetters')
...
module.exports = async function getHttpInterface(fastify, options) {
  ...
  //   return data => JSON.stringify(data, (_, value) => {
