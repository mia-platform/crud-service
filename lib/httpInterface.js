  ...
  if (registerSetters) {
    ...
    fastify.post(
      '/import',
      {
        schema: importSchema,
        config: {
          itemValidator: getAjvResponseValidationFunction(importSchema.streamBody),
          validateImportOptions: getAjvResponseValidationFunction(schemaWithoutFile, { removeAdditional: false }),
        },
      },
