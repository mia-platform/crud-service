...
module.exports = {
  getFileMimeStringifiers: (contentType, parsingOptions = {}) => {
    const mimeStringify = {
      // TODO: move stringifiers and parser in this file into the trasformer directory
      ...
      'application/vnd.ms-excel': excel.stringifier,
      'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': excel.stringifier,
    }
