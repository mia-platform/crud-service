...
const getFieldDefinitionCompatibility = (collectionDefinition) => collectionDefinition
  .fields
  .reduce((acc, field) => {
...
const getFieldDefinition = (collectionDefinition) => {
  ...
  return Object
    ...
    .reduce((acc, [propertyName, jsonSchema]) => {
      if (jsonSchema.specialType) {
        acc[propertyName] = jsonSchema.specialType
        return acc
      }
...
const getNullableFieldsCompatibility = (collectionDefinition) => collectionDefinition
  .fields
  .reduce((acc, field) => {
...
const getRawObjectFieldsCompatibility = (collectionDefinition) => {
