...
function removeDisallowedFields(fieldsInProjection, aclColumns) {
...
function removeAclColumnsFromRawProjection(rawProjectionObject, aclColumns) {
  ...
  const filteredFields = removeDisallowedFields(rawProjectionFields, aclColumns)
