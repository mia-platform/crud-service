...
const generatePathFieldsForRawSchemaDeprecated = (logger, collectionDefinition) => collectionDefinition
  .fields
  .filter(field => {
...
module.exports = function generatePathFieldsForRawSchema(logger, collectionDefinition) {
  if (!collectionDefinition.schema) {
    return generatePathFieldsForRawSchemaDeprecated(logger, collectionDefinition)
  }
