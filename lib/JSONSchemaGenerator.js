...
function propertiesPatchCommandsValidation(collectionDefinition, rawPathsAndPatternProperties = {}) {
  ...
  const pushPatternProperties = getPushPatternProperties(rawPathsAndPatternProperties.patternProperties)
  ...
  return {
    ...
    [PUSHCMD]: {
      type: 'object',
      properties: getPushProperties(collectionDefinition, rawPathsAndPatternProperties.paths),
      ...Object.keys(pushPatternProperties).length > 0 ? { patternProperties: pushPatternProperties } : {},
      additionalProperties: false,
    },
  }
}
...
function getPushProperties(collectionDefinition, rawPaths = {}) {
...
function getPushPatternProperties(rawPatternProperties = {}) {
