...
module.exports = class JSONSchemaGenerator {
  constructor(
    ...
    const { type: idType } = collectionDefinition.fields.find(field => field.name === MONGOID) ?? {}
    const { endpointBasePath, fields } = collectionDefinition
    ...
    this._requiredFields = getRequiredFields(fields)
