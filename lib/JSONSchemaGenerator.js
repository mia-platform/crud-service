...
module.exports = class JSONSchemaGenerator {
  constructor(
    ...
    const validationGetProperties = propertiesGetValidation(collectionDefinition)
    ...
    this._collectionDefinition = structuredClone(collectionDefinition)
    ...
    this._queryStringFromPaths = getQueryStringFromRawSchema(this._pathFieldsRawSchema.paths)
    ...
    this._propertiesGetExportValidation = propertiesGetExportValidation(
      structuredClone(this._propertiesGetListValidation),
      idType,
      sort
    )
    this._propertiesDeleteValidation = propertiesDeleteValidation(structuredClone(this._propertiesGetValidation))
    ...
    this._propertiesUpsertCommandsValidation = propertiesUpsertCommandsValidation(
      structuredClone(this._propertiesPatchCommandsValidation),
      validationProperties
    )
    ...
    this._propertiesPatchQueryValidation = structuredClone(this._propertiesDeleteValidation)
    ...
    this._propertiesCountValidation = {
      ...
      ...structuredClone(this._propertiesDeleteValidation),
    }
